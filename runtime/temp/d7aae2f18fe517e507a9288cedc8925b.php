<?php /*a:2:{s:80:"/Users/liuwei/www/local/hulacwms_v2/application/admin/view/friendlink/index.html";i:1592735982;s:75:"/Users/liuwei/www/local/hulacwms_v2/application/admin/view/public/base.html";i:1592735982;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="layui-card-body">
                <div class="layui-row zz-row-operate">
                    <div class="zz-operate-btn-group">
                        <a class="layui-btn open-win"  title="新增友情链接" href="<?php echo url('add_link'); ?>">新 增</a>
                        <a class="layui-btn layui-btn-danger zz-btn-delete-all" href="<?php echo url('del_link'); ?>">批量删除</a>
                    </div>
                    <form action="<?php echo url(''); ?>" class="layui-form zz-form-search zz-form zz-form-right">
                        <div class="layui-inline">
                            <div class="layui-input-inline">
                                <input type="text" name="nickname" placeholder="请输入友情链接名称" value="<?php echo htmlentities($nickname); ?>" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline">
                ...
                <div class="layui-form">
                    <table class="layui-table">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo url('edit_link?id='.$vo['id']); ?>" class="layui-btn layui-btn-xs layui-btn-normal open-win" title="编辑">编辑</a>
                                <a href="<?php echo url('del_link?ids='.$vo['id']); ?>" class="layui-btn layui-btn-danger layui-btn-xs confirm ajax-post">删除</a>
                            </td>
                        </tr>
