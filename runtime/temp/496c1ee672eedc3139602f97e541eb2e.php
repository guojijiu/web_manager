<?php /*a:2:{s:86:"/Users/liuwei/www/local/hulacwms_v2/application/admin/view/documentcategory/index.html";i:1592735982;s:75:"/Users/liuwei/www/local/hulacwms_v2/application/admin/view/public/base.html";i:1592735982;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
			...
			<div class="layui-card-body">
				<div class="layui-row zz-row-operate">
					<div class="zz-operate-btn-group">
						<a class="layui-btn" href="<?php echo url('add_category?id=0'); ?>" title="新增顶级分类">新增顶级分类</a>
					</div>
				</div>
...
<script>
	layui.use('jquery', function() {
		var listData = <?php echo $listJson; ?>;
		var $ = layui.$;
		...
		function renderLists($lists, $parentDom) {
			for (var x in $lists) {
				...
				//添加子栏目按钮
				var treeItemAddChild = $("<a href=\"<?php echo url('add_category'); ?>?pid=" + $lists[x].id + "\" class=\"layui-icon layui-icon-add-1\"></a>");
				treeItemTitleColumn.append(treeItemAddChild);

				//栏目排序列
				var treeItemSortColumn = $("<div class=\"zz-tree-item-sort\"><form action=\"<?php echo url('sort'); ?>\" method=\"post\" class=\"layui-form zz-form-datalist\" lay-filter=\"zz-form-" + $lists[x].id + "\">"
				...
				//显示隐藏列
				var treeItemDisplayColumn = $("<div class='zz-tree-item-display'> <input type=\"checkbox\" lay-filter=\"zz-switch-display\"  data-href=\"<?php echo url('set_display'); ?>?id=" + $lists[x].id
				...
				//操作按钮
				var treeItemOptionColumn = $("<div class=\"zz-tree-item-option\"><a class=\"layui-btn layui-btn-xs layui-btn-normal\" href=\"<?php echo url('edit_category'); ?>?id=" + $lists[x].id + "\" title=\"编辑\">编辑</a>"
						+ "<a class=\"layui-btn layui-btn-xs\" href=\"<?php echo url('document/add_document'); ?>?cid=" + $lists[x].id + "\" title=\"添加文章\">添加文章</a>"
						+ "<a class=\"layui-btn layui-btn-xs\" href=\"<?php echo url('document/index'); ?>?category_id=" + $lists[x].id + "\" title=\"查看此分类下所有文章\">查看所有文章</a>"
						+ "<a class=\"layui-btn layui-btn-danger layui-btn-xs ajax-post confirm lbtn-del-category\" href=\"<?php echo url('del_category'); ?>?ids=" + $lists[x].id + "\">删除</a></div>");
